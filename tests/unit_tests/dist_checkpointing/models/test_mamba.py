...
try:
    ...
    print("mamba modules not available")
...
def initialize_mamba(seed, glu=True, **config_kwargs):
    ...
    submodules = MambaMixerSubmodules(
        # TODO: norm is actually missing for hpu
        in_proj=TELayerNormColumnParallelLinear if HAVE_TE else IntelTEColumnParallelLinear,
