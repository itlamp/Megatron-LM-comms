...
def get_mamba_stack_modelopt_spec(
    ...
    normalization_class = TENorm if HAVE_TE else IntelTENorm
    ...
    te_core_attention = TEDotProductAttention if HAVE_TE else IntelTEDotProductAttention
    core_attention = DotProductAttention if local_core_attention else te_core_attention
